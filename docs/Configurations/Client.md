...
key_key.sprint:key.keyboard.caps.lock
...
key_key.the_bumblezone.beehemoth_down:key.keyboard.space
...
key_key.craftingtweaks.toggleButtons:key.keyboard.unknown
...
key_key.gravelminer.toggle:key.keyboard.unknown
key_Toggle Drippy Customization Overlay | CTRL + ALT + :key.keyboard.l
...
key_key.waila.show_recipes:key.keyboard.keypad.3
key_key.waila.show_uses:key.keyboard.keypad.4
...
key_xray.config.toggle:key.keyboard.backslash
key_xray.config.open:key.keyboard.g
key_key.entityculling.toggle:key.keyboard.unknown
key_key.aa2.reload:key.keyboard.r
...
key_keybind.ironjetpacks.hover:key.keyboard.g
...
key_key.veinmining.activate.desc:key.keyboard.unknown
...
key_key.plane_boost.desc:key.keyboard.space
key_key.plane_engine_open.desc:key.keyboard.x
key_key.plane_drop_payload.desc:key.keyboard.c
key_key.buildinggadgets.settings_menu:key.keyboard.g
key_key.buildinggadgets.range:key.keyboard.r
key_key.buildinggadgets.undo:key.keyboard.u
key_key.buildinggadgets.anchor:key.keyboard.h
key_key.buildinggadgets.fuzzy:key.keyboard.unknown
key_key.buildinggadgets.connected_area:key.keyboard.unknown
key_key.buildinggadgets.rotate_mirror:key.keyboard.unknown
key_key.buildinggadgets.material_list:key.keyboard.m
...
key_Copy Container Class:key.keyboard.unknown
key_Show Slot Index Tooltips:key.keyboard.unknown
key_key.mekanismadditions.voice:key.keyboard.u
key_key.leap.double_jump:key.keyboard.space
...
key_key.observable.profile:key.keyboard.r
key_key.trajanscore.tankMovement:key.keyboard.w
key_key.trajanscore.shootKey:key.keyboard.g
key_key.trajanscore.fuelRemaining:key.keyboard.left.control
...
key_key.modifier:key.keyboard.equal
key_key.submode:key.keyboard.unknown
key_key.openManual:key.keyboard.f1
key_key.unmountVehicle:key.keyboard.backslash
key_walljump.key.walljump:key.keyboard.left.shift
...
key_key.waila.narrate:key.keyboard.keypad.6
...
key_key.car_forward:key.keyboard.w
key_key.car_back:key.keyboard.s
key_key.car_left:key.keyboard.a
key_key.car_right:key.keyboard.d
key_key.car_gui:key.keyboard.i
key_key.car_start:key.keyboard.r
key_key.car_horn:key.keyboard.h
key_key.center_car:key.keyboard.space
...
key_key.cyclic.cake:key.keyboard.x
...
key_key.cgm.attachments:key.keyboard.z
key_key.zoom:key.keyboard.c
key_key.supercircuitmaker.open_palette:key.keyboard.left.alt
key_key.supercircuitmaker.component_placement_modifier:key.keyboard.left.control
